...
<html lang="en">
<?php
    include("handler/authValidate.php");
                            ...
                            <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div class="p-t-15">
                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="hidden" name="total" value="<?php echo $total ?>">
                                        </div>
                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="phone" placeholder="Enter your phone">
                                        </div>
                                        <div class="bor8 bg0 m-b-12">
